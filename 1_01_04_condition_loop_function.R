...
# "setosa", "versicolor", "virginica"를 
# 각각 1, 2, 3 으로 추출하기 위한 방법
# factor -> 숫자의 vector로 변환
uc <- unclass(df$Species) # "setosa", "versicolor", "virginica"
uc # "setosa", "versicolor", "virginica"가 각각 1, 2, 3으로 수정된 벡터
# "setosa", "versicolor", "virginica"의 색상으로
# red green blue 지정하도록 준비
c("red", "green", "blue")[c(1, 2, 3, 1)]
c("red", "green", "blue")[unclass(df$Species)]
